...
export const processFilters = (data: Record<string, CountryInfo>, filters: Filters) => {
  ...
  return Object.fromEntries(processed.map(({ country, info, dataPoint }) => [country, { ...info, data: [dataPoint] }]));
};
